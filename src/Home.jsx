...
const Home = () => {
    ...
    return (
        <div className='relative [perspective:1000px] overflow-hidden'>
            ...
            <div className='absolute top-24 flex w-full items-center justify-center flex-col gap-4 px-2 sm:px-5'>
                <div className="flex flex-col md:text-5xl text-3xl !leading-normal text-indigo-500 text-center mx-auto font-[1000] my-10">
                    <div className='animate-enter'>Hi👋, myself <span className='span'>Prathmesh,</span></div>
                    <span className='animate-enter opacity-0 [animation-delay:_0.5s] '>I'm a Software Developer.</span>
                </div>
